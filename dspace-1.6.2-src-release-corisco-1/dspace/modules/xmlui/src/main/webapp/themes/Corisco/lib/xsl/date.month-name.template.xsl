...
<date:months>
   <date:month abbr="Jan">Janeiro</date:month>
   <date:month abbr="Feb">Fevereiro</date:month>
   <date:month abbr="Mar">Março</date:month>
   <date:month abbr="Apr">Abril</date:month>
   <date:month abbr="May">Maio</date:month>
   <date:month abbr="Jun">Junho</date:month>
   <date:month abbr="Jul">Julho</date:month>
   <date:month abbr="Aug">Agosto</date:month>
   <date:month abbr="Sep">Setembro</date:month>
   <date:month abbr="Oct">Outubro</date:month>
   <date:month abbr="Nov">Novembro</date:month>
   <date:month abbr="Dec">Dezembro</date:month>
</date:months>
